      ...
      <div v-if="book"
        ...
        <div class="max-w-2xl mx-auto">
          ...
          <div class="flex gap-6">
            <div
              class="w-24 h-36 bg-slate-100 dark:bg-zinc-800 rounded-lg flex flex-col items-center justify-center shrink-0">
              <img :src="bookshelfApi.getThumbnailUrl(book.id)" alt="book cover">
            </div>
          ...
          <div class="mt-6 grid grid-cols-[repeat(auto-fit,minmax(280px,1fr))] gap-3">
            ...
            <button v-if="book.amount >= 1" @click="removeBook"
              ...
              {{ adding ? 'Removing...' : 'Remove from Collection' }}
            </button>
          </div>
        </div>
      </div>
