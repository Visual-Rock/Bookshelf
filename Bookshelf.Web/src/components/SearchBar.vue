<template>
  <div class="relative w-full max-w-md">
    <span class="material-icons absolute left-3 top-1/2 -translate-y-1/2 !text-[1rem] pointer-events-none text-slate-400 dark:text-zinc-500 transition-colors duration-300">
      search
    </span>
    <input
      v-model="modelValue"
